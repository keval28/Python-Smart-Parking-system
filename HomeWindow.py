...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#00cccc;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
    ...
    def showAdd(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#00cccc;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
    ...
    def showManage(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#00cccc;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
    ...
    def showHistory(self):
        ...
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#F97C2C;color:#fff;font-weight:bold;border:1px solid white;")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#00cccc;color:#fff;font-weight:bold;border:1px solid white;")
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3] == 1:
                label.setStyleSheet(
                    "background-color:#41C300;color:white;padding:5px;width:120px;height:160px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet(
                    "background-color:red;color:white;padding:5px;width:120px;height:160px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#41C300;border:1px solid white")
        ...
        for data in alldata:
            ...
            if data[3] == 1:
                label.setStyleSheet("background-color:#41C300;color:white;padding:5px;width:120px;height:160px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:red;color:white;padding:5px;width:120px;height:160px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addAddVehiclePage(self):
        layout = QVBoxLayout()
        frame = QFrame()

        name_label = QLabel("Name : ")
        name_label.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        mobile_label = QLabel("Mobile : ")
        mobile_label.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        vechicle_label = QLabel("Vehicle No : ")
        vechicle_label.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        vechicle_type = QLabel("Vehicle Type : ")
        vechicle_type.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        error_label = QLabel("")
        error_label.setStyleSheet("color:red;padding:8px 0px;font-size:20px")

        name_input = QLineEdit()
        name_input.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        mobile_input = QLineEdit()
        mobile_input.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        vehicle_input = QLineEdit()
        vehicle_input.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px")
        vtype = QComboBox()
        vtype.setStyleSheet("color:#ffffff;padding:8px 0px;font-size:20px;border:1px solid white")
    ...
    def addManagePage(self):
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet("color:#fff;padding:5px 0px;font-size:20px;background:#41C300;border:1px solid white")

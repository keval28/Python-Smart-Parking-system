...
class LoginScreen(QWidget):
    def __init__(self):
        ...
        self.input_username.setStyleSheet("padding:5px;font-size:12px")
        ...
        self.input_password.setStyleSheet("padding:5px;font-size:12px")

        btn_login = QPushButton("Login")
        btn_login.setStyleSheet("padding:5px;font-size:20px;background:#41C300;color:#fff")
